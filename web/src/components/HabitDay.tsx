...
export function HabitDay({ defaltCompleted = 0, amount = 0, date}: HabitDayProps) {
    const [completed, setCompleted] = useState(defaltCompleted)
    ...
    function handleCompletedChanger(completed: number) {
        ...
        <Popover.Root>
            ...
            <Popover.Portal>
                <Popover.Content className="min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col">
                    ...
                    <HabitsList date={date} onCompletedChanged={handleCompletedChanger}/>
